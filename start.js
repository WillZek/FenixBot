...
try {
let listaDirectorios = readdirSync('./FenixJadiBot/');
let SBprekey = []
listaDirectorios.forEach(directorio => {
if (statSync(`./CrowJadiBot/${directorio}`).isDirectory()) {
let DSBPreKeys = readdirSync(`./FenixJadiBot/${directorio}`).filter(fileInDir => {
return fileInDir.startsWith('pre-key-')
})
SBprekey = [...SBprekey, ...DSBPreKeys]
DSBPreKeys.forEach(fileInDir => {
unlinkSync(`./CrowJadiBot/${directorio}/${fileInDir}`)
})
}
})
