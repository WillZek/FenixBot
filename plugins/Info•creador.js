...
let biografia = await conn.fetchStatus('5493876432076' +'@s.whatsapp.net').catch(_ => 'Hola me llamo WillZek y soy creador de FENIX-BOT')
...
let bio = biografia.status?.toString() || 'Hola me llamo WillZek y soy creador de FENIX-BOT'
let biobot = biografiaBot.status?.toString() || 'Hola me llamo WillZek y soy creador de  FENIX-BOT'
let name = await conn.getName(who)

await sendContactArray(conn, m.chat, [
[`50557865603`, `🔱 Propietario`, `💛 WillZek `, dev, correo, `🎌 Tokio`, `${yt}`, bio],
